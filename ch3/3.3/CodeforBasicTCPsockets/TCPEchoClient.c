...
int main(int argc, char *argv[])
{
    ...
    struct sockaddr_in echoServAddr,peerAddr; /* Echo server address */
    ...
    echoServAddr.sin_addr.s_addr = inet_addr("10.4.40.89");   /* Server IP address */
    echoServAddr.sin_port        = htons(myport); /* Server port */
...
if (bind(sock, (struct sockaddr *)&echoServAddr, sizeof(echoServAddr)) < 0)
    ...
    printf("connected peer address = %s:%d\n",
           inet_ntop(AF_INET, &peerAddr.sin_addr, echoBuffer, sizeof(echoBuffer)),
